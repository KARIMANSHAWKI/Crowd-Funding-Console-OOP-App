            ...
            if not userdata:
                ...
                while True:
                    ...
                    if userChoice == 0:
                        ...
                        projectStatus = project.createProject(userId, title, details, total, startDate,
                                                              endDate)
                        if projectStatus:
                        ...
                        status = project.deleteOneProject(userID, title)
                        if status:
                        ...
                        title = input('> enter project title: ')
                        status = project.findOneProject(userID, title)
                        if status:
                            print(status)
                            print('> Project Deleted Successfully...')
                        else:
                        ...
                        print(project.findAllProject(userID))
                    elif userChoice == 4:
                        break
    elif inputReader == 3:
        break
